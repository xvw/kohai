...
let dump_null = dump (Fmt.any "null")
let dump_unit = dump (Fmt.any "null")
let dump_bool = dump Fmt.bool
let dump_char = dump Fmt.char
let dump_int = dump Fmt.int
let dump_int32 = dump Fmt.int32
let dump_int64 = dump Fmt.int64
let dump_float = dump Fmt.float
let dump_string = dump Fmt.Dump.string
